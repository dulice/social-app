    ...
    <div className="border-b-gray-200 border-b-2 py-3 fixed top-0 w-full bg-white nav z-10">
      <div className="max-w-5xl mx-auto px-3">
        <div className="grid grid-cols-12 gap-4">
          <Link to='/' className="col-span-3 md:col-span-4 flex justify-start font-mono font-bold text-xl text-transparent bg-clip-text bg-gradient-to-r from-purple-500 via-pink-500 to-yellow-500">
            Social-Hub
          </Link>
            ...
            <form onSubmit={handleSubmit}>
              <div className="relative">
                ...
                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                  <button
                    type="submit"
                    className="bg-transparent search-btn text-xl"
                  >
                    <MdSearch />
                  </button>
                </div>
            ...
            <div className="text-right">
              <Menu as="div" className="relative inline-block text-left">
                <div>
                  <Menu.Button>
                    <img
                      className="mx-3 w-7 h-7 object-cover rounded-full"
                      src={
