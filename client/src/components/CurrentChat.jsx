...
const CurrentChat = () => {
  ...
  const { conversationId, messages, setMessages, currentUser } =
    useContext(Store);
  ...
  return (
    <div>
      ...
      <div
        className="absolute bottom-0 my-3 border p-2 rounded-full bg-white"
        style={{ width: "95%" }}
      >
        <form
          action=""
        ...
        >
          ...
          <input
            ...
            placeholder="Message..."
            className="ml-3 focus:outline-none w-5/6"
          />
